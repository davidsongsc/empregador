        ...
        <aside className="lg:col-span-4 space-y-6">
          ...
          <section className="bg-indigo-600 rounded-[28px] p-6 text-white relative overflow-hidden group">
            <div className="relative z-10 max-w-md">
              <h4 className="font-bold text-lg mb-2">Dica: Melhore seu perfil!</h4>
              <p className="text-indigo-100 text-sm leading-relaxed opacity-90">
                Candidatos com foto e currículo atualizado têm 3x mais chances de serem chamados para entrevistas.
              </p>
