      ...
      <section className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 border-b border-slate-800 pb-2">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] lg:text-xs xl:text-sm font-black tracking-[0.4em] text-amber-600 uppercase">
              Dashboard
            </span>
          </div>

          <h1 className="text-3xl md:text-4tal xl xl:text-6xl font-light text-slate-100 tracking-tighter">
          ...
          <div className="flex items-center gap-3">
            ...
            <p className="text-slate-500 text-[10px] font-medium tracking-widest uppercase">
              Code • ID: {activeMembership?.id?.slice(0, 8)}
            </p>
          </div>
        </div>
