          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            <div className="space-y-1">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-[9px] font-black text-delos-amber uppercase tracking-[0.3em]">
                  {viewMode === 'categories' ? 'Discovery_Mode' : 'Cluster_Active'}
                </span>
              </div>
              ...
              {viewMode === 'jobs' && (
                <button onClick={resetView} className="flex items-center gap-2 text-[9px] font-black text-delos-amber uppercase tracking-widest hover:underline mt-4">
