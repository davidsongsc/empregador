            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 relative z-10 gap-6">
                ...
                <div className="flex items-center gap-6 border-l border-[var(--delos-border)] pl-8">
                    <div className="text-right">
                        ...
                        <p className="text-[8px] font-mono font-black opacity-30 uppercase tracking-[0.3em] mb-1">Candidaturas</p>
                        
                        <span
                            style={{ color: 'var(--delos-indigo)' }}
                            className="text-6xl font-black leading-none tracking-tighter"
                        >
                            <div className="w-2 h-2 bg-[var(--delos-amber)] animate-pulse rounded-full absolute right-0 top-10" />
            ...
            <div className="space-y-2 relative z-10">
                ...
                {applications.length > 0 ? (
                    ...
                    >
                        ...
                        />
                        <p className="opacity-40 font-mono text-[12px] uppercase text-delos-black tracking-[0.5em] mb-6">
                            Você ainda não se candidatou-se para nenhuma vaga!
                        </p>
                        <button

                            className="px-8 py-3 border text-[10px] hover:border-delos-surface hover:text-delos-surface  hover:bg-[var(--delos-amber)]  border-delos-amber font-black  transition-all uppercase tracking-[0.3em] shadow-xl hover:shadow-sm"
                        >
                            Inicializar Busca
                        </button>
                    </div>
